...
public class RabbitMQConfig {
    ...
    public static final String TEXT_ASR_LIVE_EXCHANGE = "text.asr.live";
    ...
    @Bean
    public FanoutExchange textAsrLiveExchange() {
        return new FanoutExchange(TEXT_ASR_LIVE_EXCHANGE, true, false);
    }
